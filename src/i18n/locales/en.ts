const en: Record<string, string> = {
  ...
  'app.mainTitle': 'Lifetime Free Saju For Everyone',
  'app.mainTitleSub': 'Check Saju, Ziwei, and Natal Chart instantly',
  ...
  'form.solar': 'Solar',
  'form.lunar': 'Lunar',
  'form.lunarRegular': 'Regular month',
  'form.lunarLeap': 'Leap month',
  'form.lunarInvalid': 'Failed to convert lunar date. Please check the date again.',
  'form.yearSuffix': '',
  'form.monthSuffix': '',
  'form.daySuffix': '',
