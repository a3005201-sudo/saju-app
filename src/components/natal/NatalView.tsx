    ...
    <div className="space-y-6">
      <section className="bg-white dark:bg-gray-900 rounded-xl border border-slate-200 dark:border-slate-700 p-4">
        <LinkShareButtons
          ...
          shareText="출생차트(Natal Chart) 결과를 확인해보세요!"
        />
      </section>
      ...
      {!unknownTime && (
        <div className="bg-gradient-to-br from-white to-violet-50 dark:from-gray-900 dark:to-gray-900/70 rounded-xl border border-violet-100 dark:border-gray-700 p-5 shadow-sm">
          <NatalWheel chart={chart} />
        </div>
      )}

      {/* Planets + Angles */}
      <section className="bg-gradient-to-br from-white to-fuchsia-50 dark:from-gray-900 dark:to-gray-900/70 rounded-xl border border-fuchsia-100 dark:border-gray-700 p-5 shadow-sm">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-1 sm:gap-3">
            <h2 className="text-lg sm:text-xl font-semibold text-fuchsia-700 dark:text-fuchsia-300">출생차트 (Natal Chart)</h2>
            {!unknownTime && (
      ...
      {!unknownTime && chart.houses.length > 0 && (
        <div className="bg-gradient-to-br from-white to-cyan-50 dark:from-gray-900 dark:to-gray-900/70 rounded-xl border border-cyan-100 dark:border-gray-700 p-5 shadow-sm">
          <h3 className="text-lg font-semibold text-cyan-700 dark:text-cyan-300 mb-2">하우스 (Houses)</h3>
