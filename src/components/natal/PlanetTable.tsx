...
export default function PlanetTable({ planets, angles }: Props) {
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold text-fuchsia-700 dark:text-fuchsia-300 mb-2">행성 (Planets)</h3>
      <div className="overflow-x-auto">
        <table className="w-full text-lg">
          <thead>
            <tr className="text-base text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-gray-800">
      ...
      {angles && (
        <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-800">
          <h3 className="text-lg font-semibold text-fuchsia-700 dark:text-fuchsia-300 mb-2">축점 (Angles)</h3>
