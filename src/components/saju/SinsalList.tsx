...
export default function SinsalList({ sals }: Props) {
  ...
  return (
    <section>
      <h3 className="text-lg sm:text-xl font-semibold text-emerald-700 dark:text-emerald-300 mb-2">{withSajuKorean('神殺')}</h3>
